...
const Template2 = () => {
    ...
    const [startTimeTwo, setStartTimeTwo] = React.useState(null);
    const [endTimeTwo, setEndTimeTwo] = React.useState(null);
    ...
    return (
        <Box>
            <Grid style={{textAlign:'center'}}>
                <h2 className='create_project'> Lamps(Off)+Display</h2>
                ...
                <Grid style={{ margin: '0 10px', display: 'flex', justifyContent: 'space-between', marginTop: 8, padding: '10px 0' }} mt={5} item xs={12} sm={12} md={12}>
                    <Grid style={{ paddingTop: 8, paddingRight:50 }}>
                    <IconButton color="primary" aria-label="upload picture" component="label">
                    <input hidden accept="image/*" type="file" />
